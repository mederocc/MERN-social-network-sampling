...
const Navbar = () => {
  ...
  const isNonMobileScreens = useMediaQuery("(min-width:1000px)"); // MUI-provided media query
  const theme = useTheme(); //takes settings from properties in theme.js file
    ...
    <FlexBetween padding="1rem 6%" backgroundColor={alt}>
      <FlexBetween gap="1.74rem">
        <Typography
          ...
          //sx takes ccs properties, pseudo properties
